...
public class Utilizzatore {
	...
	public static void main(String[] args) {
		...
		Prova test2 = new ProvaBuilder().setAltezza("185").setAnnoNascita("1993").setNome("boh").setPeso(88).setCognome("bianchi").build(); //� come usare un costruttore ma con i parametri in ordine che ci pare a noi
